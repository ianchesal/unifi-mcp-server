...
export async function listFirewallGroups(client: IUnifiClient, params: { limit?: number }) {
...
export function registerFirewallTools(server: McpServer, client: IUnifiClient): void {
  server.tool(
    ...
    async (p) => {
      try {
        return toolResult(await listFirewallRules(client, p));
      } catch (e) {
        return toolError(e);
      }
    }
  ...
  server.tool(
    ...
    async ({ id }) => {
      try {
        return toolResult(await getFirewallRule(client, id));
      } catch (e) {
        return toolError(e);
      }
    }
  ...
  server.tool(
    ...
    async ({ id }) => {
      try {
        return toolResult(await deleteFirewallRule(client, id));
      } catch (e) {
        return toolError(e);
      }
    }
  ...
  server.tool(
    ...
    async (p) => {
      try {
        return toolResult(await listFirewallGroups(client, p));
      } catch (e) {
        return toolError(e);
      }
    }
  ...
  server.tool(
    ...
    async ({ id }) => {
      try {
        return toolResult(await deleteFirewallGroup(client, id));
      } catch (e) {
        return toolError(e);
      }
    }
